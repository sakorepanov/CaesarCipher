public class CaesarCypher {
    public static void main(String[] args) {
        String input = "Еъёчхф Вхзёюлх, адздёиу ф ждэщхб, црбх еёдюэчъщъгюъв южаижжзчх, ждчъёнъгжзчдв. Ъы зёюивй жёхчгюв бюнс ж ъы вдгивъгзхбсгрв аёхкдв. \n" +
            ...
            for (int i = 0; i < inputArray.length; i++) {
                if (Character.isLetter(inputArray[i])) {
                    if (Character.isUpperCase(inputArray[i])) {
                        ...
                        inputArray[i] = Character.toUpperCase(alphabet.charAt(index + j));
                    } else {
                        int index = alphabet.indexOf(input.charAt(i));
                        inputArray[i] = alphabet.charAt(index + j);
                    }
                }
